...
int main()
{
	...
	drinkType itemsArray[5][5];                                         //declare variables
	inventory machine[3];
	...
	do {                                                                //loop while input != 0
		...
		for(i = 0; i < 3; i++) {
    		...
    		case 2:
    			...
    			machine[i].buyItem(x,y);
    			break;
            case 3:
                machine[i].buyItem(2,(rand() % 5));                     //Simulating people buying drinks
                machine[i].buyItem(2,(rand() % 5));                     //2 from row 3
                if(rand() % 10 == 4) {
                    cout << "ALERT: Coins have been used to pay\n";     //simulate random coin purchases
                }
                
                machine[i].buyItem(3,(rand() % 5));
                machine[i].buyItem(3,(rand() % 5));                     //2 from row 4
                
                machine[i].buyItem(1,(2));
                machine[i].buyItem(1,(2));                              //3 from row 2 slit 3
                machine[i].buyItem(1,(2));
                if(rand() % 10 == 4) {
                    cout << "ALERT: Card has been used to pay\n";       //simulate random card purchases
                }
                
                machine[i].buyItem(0,(rand() % 5));
                machine[i].buyItem(0,(rand() % 5));                     //2 from row 1
                
                machine[i].buyItem(4,(rand() % 5));                     //1 from row 5
                
                machine[i].stuckItem();
                
                machine[i].buyItem(4,(3));
                machine[i].buyItem(4,(3));
                machine[i].buyItem(4,(3));                              //3 from row 5 slit 4
                ...
                machine[i].buyItem(0,(rand() % 5));
                machine[i].buyItem(0,(rand() % 5));
                machine[i].buyItem(0,(rand() % 5));                     //3 from row 1 random slits
                if(rand() % 10 == 4) {
                    cout << "ALERT: Card has been used to pay\n";
                }
                
                machine[i].buyItem(0,(rand() % 5));
                machine[i].buyItem(1,(rand() % 5));
                machine[i].buyItem(2,(rand() % 5));
                machine[i].buyItem(3,(rand() % 5));
                machine[i].buyItem(4,(rand() % 5));                     //1 from each row
                break;
            case 4:
